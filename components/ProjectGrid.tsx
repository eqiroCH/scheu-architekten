  ...
  return (
    ...
    >
      ...
      <div className="space-y-1.5">
        <h3 className="text-xl md:text-2xl font-light leading-tight text-gray-900 group-hover:text-gray-700 transition-colors duration-300 tracking-tight">
          {project.title}
        </h3>
        <div className="flex items-baseline gap-3 text-xs text-gray-400 uppercase tracking-[0.1em] font-light">
          <span>{project.location}</span>
          <span className="text-gray-300">/</span>
          <span>{project.year}</span>
        </div>
        {project.collaboration && (
          <p className="text-[10px] text-gray-400 italic mt-2 leading-relaxed max-w-md">
            {project.collaboration}
          </p>
        )}
      </div>
      ...
      {currentProjects.length > 0 && (
        <div>
          <div className="mb-6 md:mb-8">
            <h2 className="text-3xl md:text-4xl font-light tracking-tight mb-2 text-gray-900">
              Aktuelle Projekte
            </h2>
